...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , i_pixel_clk{vlSymsp->TOP.i_pixel_clk}
    , i_src_active_video{vlSymsp->TOP.i_src_active_video}
    , i_buffer_empty{vlSymsp->TOP.i_buffer_empty}
    , o_pixel_buffer_we{vlSymsp->TOP.o_pixel_buffer_we}
    , o_pixel_buffer_re{vlSymsp->TOP.o_pixel_buffer_re}
    , o_hsync{vlSymsp->TOP.o_hsync}
    , o_vsync{vlSymsp->TOP.o_vsync}
    , rootp{&(vlSymsp->TOP)}
{
